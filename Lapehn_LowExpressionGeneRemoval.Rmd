---
title: "Low Expression (Average logcpm<0) Gene Removal"
...
## September 2024 Filtering
Performing  filtering to remove non-protein coding genes and low expressing genes. This updated code adds the trophoblast stem cells based on reviews from Placenta submission. 
...
```{r load data}
#Full Merged Data
load(file="/active/paquette_a/slapehn/Placenta_CellLine_Comparison/Data/Merged Unfiltered Data/FullMerge_Unfiltered_090924.Rdata")
```

### Remove duplicates
```{r Remove duplicates}

sum(duplicated(FullMerge_NewIDs_Annotated$ensembl_gene_id))
sum(duplicated(FullMerge_NewIDs_Annotated$hgnc_symbol))
FullMerge_Unique <- FullMerge_NewIDs_Annotated %>%
...
Filtered_Counts_DF <- Filtered_Counts_DF[,-1237]
...
Filtered_logcpm_DF <- Filtered_logcpm_DF[,-1237]
...
#save(FilteredCounts_DF_Annotated, file="/active/paquette_a/slapehn/Placenta_CellLine_Comparison/Data/Merged Filtered Data/FilteredwithAnnotation_091124.RData")
#save(Filtered_Counts_DF, file="/active/paquette_a/slapehn/Placenta_CellLine_Comparison/Data/Merged Filtered Data/FilteredCounts_091124.RData")
#save(Filtered_logcpm_DF_Annotated, file="/active/paquette_a/slapehn/Placenta_CellLine_Comparison/Data/Merged Filtered Data/Filtered_logcpm_withAnnotation_091124.RData")
#save(Filtered_logcpm_DF, file="/active/paquette_a/slapehn/Placenta_CellLine_Comparison/Data/Merged Filtered Data/Filtered_logcpm_091124.RData")
#save(Removed_Genes_DF_Annotated, file="/active/paquette_a/slapehn/Placenta_CellLine_Comparison/Data/Merged Filtered Data/RemovedGenes_counts_091124.RData")
#save(Removed_Genes_logcpm_DF, file="/active/paquette_a/slapehn/Placenta_CellLine_Comparison/Data/Merged Filtered Data/RemovedGenes_logcpm_091124.RData")

#write.csv(Removed_Genes_logcpm_DF, "/active/paquette_a/slapehn/Placenta_CellLine_Comparison/ForShinyApp/RemovedGenes_logcpm_091124.csv")
```
