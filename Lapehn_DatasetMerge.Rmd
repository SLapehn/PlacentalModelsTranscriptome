...
## Data Merge Sept 2024
Performing a merge of CANDLE/GAPPS data with availalbe placenta cell line data as of Sept 2024 following first round of reviews with "Placenta". Based on these reviews I am  adding trophoblasts stem cells to the CTPMA.  
...
#Human TSCs
load(file="/active/paquette_a/slapehn/Placenta_CellLine_Comparison/Data/Unfiltered Data/GSE208538_TSC_Controls_090924.RData")
TSC_1 <- GSE208538_Controls_Annotated

load(file="/active/paquette_a/slapehn/Placenta_CellLine_Comparison/Data/Unfiltered Data/GSE209976_TSC_Controls_090924.RData")
TSC_2 <- GSE209976_Controls_Annotated

load(file="/active/paquette_a/slapehn/Placenta_CellLine_Comparison/Data/Unfiltered Data/GSE196259_TSC_Controls_090924.RData")
TSC_3 <- GSE196259_Controls_Annotated

load(file="/active/paquette_a/slapehn/Placenta_CellLine_Comparison/Data/Unfiltered Data/GSE188738_TSC_Controls_090924.RData")
TSC_4 <- GSE188738_Controls_Annotated
...
#TSCs
TSC_1_2<- full_join(TSC_1, TSC_2)
TSC_1_2_3 <- full_join(TSC_1_2, TSC_3)
TSC_All <- full_join(TSC_1_2_3, TSC_4)
#save(TSC_All, file="/active/paquette_a/slapehn/Placenta_CellLine_Comparison/Data/Merged Cell Line Unfiltered Data/JAR_Merged_Unfiltered_090924.Rdata")
...
Primary_HTR8_Bewo_JEG3_JAR_Explant_TSC <- full_join(Primary_HTR8_Bewo_JEG3_JAR_Explant, TSC_All)
FullMerge <- full_join(Primary_HTR8_Bewo_JEG3_JAR_Explant_TSC, CANDLE_GAPPS)
