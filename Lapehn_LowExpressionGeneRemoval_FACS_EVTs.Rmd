---
title: "Low Expression Gene Removal (average logcpm<0) for FACS EVT Analysis"
...
## Low Expression Gene Filtering for FACS EVT Analysis
Performing  filtering to remove non-protein coding genes and low expressing genes
...
```{r load data}
#Full Merged Data
load(file="/active/paquette_a/slapehn/Placenta_CellLine_Comparison/Data/Merged Unfiltered Data/FullMerge_Unfiltered_FACS_EVT_111723.Rdata")
```
...
Filtered_Counts_DF <- Filtered_Counts_DF[,-137]
...
Filtered_logcpm_DF <- Filtered_logcpm_DF[,-137]
...
#save(FilteredCounts_DF_Annotated, file="/active/paquette_a/slapehn/Placenta_CellLine_Comparison/Data/Merged Filtered Data/FilteredwithAnnotation_FACS_EVT_111723.RData")
#save(Filtered_Counts_DF, file="/active/paquette_a/slapehn/Placenta_CellLine_Comparison/Data/Merged Filtered Data/FilteredCounts_FACS_EVT_111723.RData")
#save(Filtered_logcpm_DF_Annotated, file="/active/paquette_a/slapehn/Placenta_CellLine_Comparison/Data/Merged Filtered Data/Filtered_logcpm_withAnnotation_FACS_EVT_111723.RData")
#save(Filtered_logcpm_DF, file="/active/paquette_a/slapehn/Placenta_CellLine_Comparison/Data/Merged Filtered Data/Filtered_logcpm_FACS_EVT_111723.RData")
#save(Removed_Genes_DF_Annotated, file="/active/paquette_a/slapehn/Placenta_CellLine_Comparison/Data/Merged Filtered Data/RemovedGenes_counts_FACS_EVT_111723.RData")
#save(Removed_Genes_logcpm_DF, file="/active/paquette_a/slapehn/Placenta_CellLine_Comparison/Data/Merged Filtered Data/RemovedGenes_logcpm_FACS_EVT_111723.RData")
```
