---
title: "Low Expression Gene Filtering (average logcpm<0) for Villous Digest STB Analysis"
...
## Low Expression Gene Filtering for FACS STB Analysis
Performing  filtering to remove non-protein coding genes and low expressing genes (average logcpm<0)
...
```{r load data}
#Full Merged Data
load(file="/active/paquette_a/slapehn/Placenta_CellLine_Comparison/Data/Merged Unfiltered Data/FullMerge_Unfiltered_FACS_STB_111723.Rdata")
```

### Remove duplicates
```{r Remove duplicates}

sum(duplicated(FullMerge_NewIDs_Annotated_STB$ensembl_gene_id))
sum(duplicated(FullMerge_NewIDs_Annotated_STB$hgnc_symbol))
FullMerge_Unique <- FullMerge_NewIDs_Annotated_STB %>%
...
Filtered_Counts_DF <- Filtered_Counts_DF[,-135]
...
Filtered_logcpm_DF <- Filtered_logcpm_DF[,-135]
...
#save(FilteredCounts_DF_Annotated, file="/active/paquette_a/slapehn/Placenta_CellLine_Comparison/Data/Merged Filtered Data/FilteredwithAnnotation_FACS_STB_111723.RData")
#save(Filtered_Counts_DF, file="/active/paquette_a/slapehn/Placenta_CellLine_Comparison/Data/Merged Filtered Data/FilteredCounts_FACS_STB_111723.RData")
#save(Filtered_logcpm_DF_Annotated, file="/active/paquette_a/slapehn/Placenta_CellLine_Comparison/Data/Merged Filtered Data/Filtered_logcpm_withAnnotation_FACS_STB_111723.RData")
#save(Filtered_logcpm_DF, file="/active/paquette_a/slapehn/Placenta_CellLine_Comparison/Data/Merged Filtered Data/Filtered_logcpm_FACS_STB_111723.RData")
#save(Removed_Genes_DF_Annotated, file="/active/paquette_a/slapehn/Placenta_CellLine_Comparison/Data/Merged Filtered Data/RemovedGenes_counts_FACS_STB_111723.RData")
#save(Removed_Genes_logcpm_DF, file="/active/paquette_a/slapehn/Placenta_CellLine_Comparison/Data/Merged Filtered Data/RemovedGenes_logcpm_FACS_STB_111723.RData")
```
