---
title: "Dynamic Hierarchical Clustering"
...
```{r load data}
load(file="/active/paquette_a/slapehn/Placenta_CellLine_Comparison/Data/VoomTransformed_111723.RData")
SampleMetadata <-read.csv("/active/paquette_a/slapehn/Placenta_CellLine_Comparison/SampleID_Key_Nov2023.csv")
...
```{r combine}
Avg_Expr <- cbind(HTR8_Expr$HTR8SVneo, BeWo_Expr$BeWo, JAR_Expr$JAR, JEG3_Expr$JEG3, Primary_Expr$PrimaryTrophoblast, Explant_Expr$VillousExplants, Placenta_Expr$PlacentaTissue)
colnames(Avg_Expr) <- c("HTR8SVneo", "BeWo", "JAR", "JEG3", "PrimaryTrophoblasts", "VillousExplants", "PlacentaTissue")
...
ClusterHeatmap <-pheatmap(AvgExpr_Heatmap,
         ...
         clustering_distance_cols ="euclidean", 
         clustering_distance_rows= "euclidean",
         main="Clustering of All Genes (12,793), DynamicCutHeight=8, minCluster=50")
```

## Save relevant data
```{r save relevant data}
#Save the data used to generate the clusters
#save(AvgExpr_Heatmap, file="/active/paquette_a/slapehn/Placenta_CellLine_Comparison/Results/Clustering Nov 2023/AvgExpression_forClustering_Nov2023.RData")

#Gene-Cluster Key for Annotation
#save(clusters_8_DF_test, file="/active/paquette_a/slapehn/Placenta_CellLine_Comparison/Results/Clustering Nov 2023/GeneClusterAnnotationKey_Nov2023.RData")

#Average expression with Cluster Annotation
#save(AvgExpr_DF_Clusters8_test, file="/active/paquette_a/slapehn/Placenta_CellLine_Comparison/Results/Clustering Nov 2023/AvgExpression_withClusterannotation_Nov2023.RData")

#Heatmap Object
#save(ClusterHeatmap, file="/active/paquette_a/slapehn/Placenta_CellLine_Comparison/Results/Clustering Nov 2023/ClusteringHeatmapObject_Nov2023.RData")
...
pheatmap(Cluster_0_Heatmap_Dyn,
         ...
         fontsize_col = 0.5, 
         clustering_method = "average", 
         main="Dynamic Cluster 0 (333 genes)")
...
pheatmap(Cluster_1_Heatmap_Dyn,
         ...
         fontsize_col = 0.5, 
         clustering_method = "average", 
         main="Dynamic Cluster 1 (1353 genes)")
...
pheatmap(Cluster_2_Heatmap_Dyn,
         ...
         fontsize_col = 0.5, 
         clustering_method = "average", 
         main="Dynamic Cluster 2 (820 genes)")
...
pheatmap(Cluster_3_Heatmap_Dyn,
         ...
         fontsize_col = 0.5, 
         clustering_method = "average", 
         main="Dynamic Cluster 3 (591 genes)")
...
pheatmap(Cluster_4_Heatmap_Dyn,
         ...
         fontsize_col = 0.5, 
         clustering_method = "average", 
         main="Dynamic Cluster 4 (539 genes)")
...
pheatmap(Cluster_5_Heatmap_Dyn,
         ...
         fontsize_col = 0.5, 
         clustering_method = "average", 
         main="Dynamic Cluster 5 (441 genes)")
...
pheatmap(Cluster_6_Heatmap_Dyn,
         ...
         fontsize_col = 0.5, 
         clustering_method = "average", 
         main="Dynamic Cluster 6 (414 genes)")
...
pheatmap(Cluster_7_Heatmap_Dyn,
         ...
         fontsize_col = 0.5, 
         clustering_method = "average", 
         main="Dynamic Cluster 7 (403 genes)")
...
pheatmap(Cluster_8_Heatmap_Dyn,
         ...
         fontsize_col = 0.5, 
         clustering_method = "average", 
         main="Dynamic Cluster 8 (349 genes)")
...
pheatmap(Cluster_9_Heatmap_Dyn,
         ...
         fontsize_col = 0.5, 
         clustering_method = "average", 
         main="Dynamic Cluster 9 (348 genes)")
...
pheatmap(Cluster_10_Heatmap_Dyn,
         ...
         fontsize_col = 0.5, 
         clustering_method = "average", 
         main="Dynamic Cluster 10 (330 genes)")
...
pheatmap(Cluster_11_Heatmap_Dyn,
         ...
         fontsize_col = 0.5, 
         clustering_method = "average", 
         main="Dynamic Cluster 11 (324 genes)")
...
pheatmap(Cluster_12_Heatmap_Dyn,
         ...
         fontsize_col = 0.5, 
         clustering_method = "average", 
         main="Dynamic Cluster 12 (324 genes)")
...
pheatmap(Cluster_13_Heatmap_Dyn,
         ...
         fontsize_col = 0.5, 
         clustering_method = "average", 
         main="Dynamic Cluster 13 (319 genes)")
...
pheatmap(Cluster_14_Heatmap_Dyn,
         ...
         fontsize_col = 0.5, 
         clustering_method = "average", 
         main="Dynamic Cluster 14 (306 genes)")
...
pheatmap(Cluster_15_Heatmap_Dyn,
         ...
         fontsize_col = 0.5, 
         clustering_method = "average", 
         main="Dynamic Cluster 15 (290 genes)")
...
pheatmap(Cluster_16_Heatmap_Dyn,
         ...
         fontsize_col = 0.5, 
         clustering_method = "average", 
         main="Dynamic Cluster 16 (283 genes)")
...
pheatmap(Cluster_17_Heatmap_Dyn,
         ...
         fontsize_col = 0.5, 
         clustering_method = "average", 
         main="Dynamic Cluster 17 (279 genes)")
...
pheatmap(Cluster_18_Heatmap_Dyn,
         ...
         fontsize_col = 0.5, 
         clustering_method = "average", 
         main="Dynamic Cluster 18 (270 genes)")
...
pheatmap(Cluster_19_Heatmap_Dyn,
         ...
         fontsize_col = 0.5, 
         clustering_method = "average", 
         main="Dynamic Cluster 19 (258 genes)")
...
pheatmap(Cluster_20_Heatmap_Dyn,
         ...
         fontsize_col = 0.5, 
         clustering_method = "average", 
         main="Dynamic Cluster 20 (219 genes)")
...
pheatmap(Cluster_21_Heatmap_Dyn,
         ...
         fontsize_col = 0.5, 
         clustering_method = "average", 
         main="Dynamic Cluster 21 (198 genes)")
...
pheatmap(Cluster_22_Heatmap_Dyn,
         ...
         fontsize_col = 0.5, 
         clustering_method = "average", 
         main="Dynamic Cluster 22 (195 genes)")
...
pheatmap(Cluster_23_Heatmap_Dyn,
         ...
         fontsize_col = 0.5, 
         clustering_method = "average", 
         main="Dynamic Cluster 23 (175 genes)")
...
pheatmap(Cluster_25_Heatmap_Dyn,
         ...
         fontsize_col = 0.5, 
         clustering_method = "average", 
         main="Dynamic Cluster 25 (169 genes)")
...
pheatmap(Cluster_26_Heatmap_Dyn,
         ...
         fontsize_col = 0.5, 
         clustering_method = "average", 
         main="Dynamic Cluster 26 (167 genes)")
...
pheatmap(Cluster_27_Heatmap_Dyn,
         ...
         fontsize_col = 0.5, 
         clustering_method = "average", 
         main="Dynamic Cluster 27 (161 genes)")
...
pheatmap(Cluster_28_Heatmap_Dyn,
         ...
         fontsize_col = 0.5, 
         clustering_method = "average", 
         main="Dynamic Cluster 28 (160 genes)")
...
pheatmap(Cluster_29_Heatmap_Dyn,
         ...
         fontsize_col = 0.5, 
         clustering_method = "average", 
         main="Dynamic Cluster 29 (160 genes)")
...
pheatmap(Cluster_30_Heatmap_Dyn,
         ...
         fontsize_col = 0.5, 
         clustering_method = "average", 
         main="Dynamic Cluster 30 (156 genes)")
...
pheatmap(Cluster_31_Heatmap_Dyn,
         ...
         fontsize_col = 2, 
         clustering_method = "average", 
         main="Dynamic Cluster 31 (148 genes)")
...
pheatmap(Cluster_32_Heatmap_Dyn,
         ...
         fontsize_col = 2, 
         clustering_method = "average", 
         main="Dynamic Cluster 32 (143 genes)")
...
pheatmap(Cluster_33_Heatmap_Dyn,
         ...
         fontsize_col = 2, 
         clustering_method = "average", 
         main="Dynamic Cluster 33 (139 genes)")
...
pheatmap(Cluster_34_Heatmap_Dyn,
         ...
         fontsize_col = 2, 
         clustering_method = "average", 
         main="Dynamic Cluster 34 (137 genes)")
...
pheatmap(Cluster_35_Heatmap_Dyn,
         ...
         fontsize_col = 2, 
         clustering_method = "average", 
         main="Dynamic Cluster 35 (134 genes)")
...
pheatmap(Cluster_36_Heatmap_Dyn,
         ...
         fontsize_col = 2, 
         clustering_method = "average", 
         main="Dynamic Cluster 36 (127 genes)")
...
pheatmap(Cluster_39_Heatmap_Dyn,
         ...
         fontsize_col = 2, 
         clustering_method = "average", 
         main="Dynamic Cluster 39 (120 genes)")
...
pheatmap(Cluster_40_Heatmap_Dyn,
         ...
         fontsize_col = 2, 
         clustering_method = "average", 
         main="Dynamic Cluster 40 (119 genes)")
...
pheatmap(Cluster_41_Heatmap_Dyn,
         ...
         fontsize_col = 2, 
         clustering_method = "average", 
         main="Dynamic Cluster 41 (113 genes)")
...
pheatmap(Cluster_42_Heatmap_Dyn,
         ...
         fontsize_col = 2, 
         clustering_method = "average", 
         main="Dynamic Cluster 42 (112 genes)")
...
pheatmap(Cluster_43_Heatmap_Dyn,
         ...
         fontsize_col = 2, 
         clustering_method = "average", 
         main="Dynamic Cluster 43 (108 genes)")
...
pheatmap(Cluster_44_Heatmap_Dyn,
         ...
         fontsize_col = 2, 
         clustering_method = "average", 
         main="Dynamic Cluster 44 (102 genes)")
...
pheatmap(Cluster_45_Heatmap_Dyn,
         ...
         fontsize_col = 3, 
         clustering_method = "average", 
         main="Dynamic Cluster 45 (89 genes)")
...
pheatmap(Cluster_46_Heatmap_Dyn,
         ...
         fontsize_col = 3, 
         clustering_method = "average", 
         main="Dynamic Cluster 46 (80 genes)")
...
pheatmap(Cluster_47_Heatmap_Dyn,
         ...
         fontsize_col = 3, 
         clustering_method = "average", 
         main="Dynamic Cluster 47 (79 genes)")
...
pheatmap(Cluster_48_Heatmap_Dyn,
         ...
         fontsize_col = 3, 
         clustering_method = "average", 
         main="Dynamic Cluster 48 (79 genes)")
...
pheatmap(Cluster_49_Heatmap_Dyn,
         ...
         fontsize_col = 3, 
         clustering_method = "average", 
         main="Dynamic Cluster 49 (61 genes)")
...
pheatmap(Cluster_50_Heatmap_Dyn,
         ...
         fontsize_col = 4, 
         clustering_method = "average", 
         main="Dynamic Cluster 50 (52 genes)")
...
pheatmap(Cluster_51_Heatmap_Dyn,
         ...
         fontsize_col = 4, 
         clustering_method = "average", 
         main="Dynamic Cluster 51 (51 genes)")
...
pheatmap(Cluster_52_Heatmap_Dyn,
         ...
         fontsize_col = 4, 
         clustering_method = "average", 
         main="Dynamic Cluster 52 (50 genes)")
```
...
#save(Cluster_GeneLists, file="/active/paquette_a/slapehn/Placenta_CellLine_Comparison/Results/Clustering Nov 2023/Cluster_GeneLists_111723.RData")

#Save background list 
Cluster_PathwayBackground <- rownames(AvgExpr_DF)

#save(Cluster_PathwayBackground, file="/active/paquette_a/slapehn/Placenta_CellLine_Comparison/Results/Clustering Nov 2023/Cluster_PathwayBackground_111723.RData")
...
#write.csv(PlacentaOnly_Clusters, "/active/paquette_a/slapehn/Placenta_CellLine_Comparison/Results/Clustering Nov 2023/HPA_PlacentaOnlyClusterAnnotation_111723.csv")
...
#write.csv(PlacentaEnriched_Clusters, "/active/paquette_a/slapehn/Placenta_CellLine_Comparison/Results/Clustering Nov 2023/HPA_PlacentaEnrichedClusterAnnotation_111723.csv")
...
#write.csv(PlacentaEnhanced_Clusters, "/active/paquette_a/slapehn/Placenta_CellLine_Comparison/Results/Clustering Nov 2023/HPA_PlacentaEnhancedClusterAnnotation_111723.csv")
...
HPA_PlacentaOnly_Clusters <- HPA_PlacentaOnly_Clusters %>%
  dplyr::select("Cluster.0", "Cluster.16", "Cluster.18", "Cluster.30", "Cluster.51")
colnames(HPA_PlacentaOnly_Clusters) <- c("Cluster 0", "Cluster 16", "Cluster 18", "Cluster 30", "Cluster 51")
...
#write.csv(ADMECore_Clusters, "/active/paquette_a/slapehn/Placenta_CellLine_Comparison/Results/Clustering Nov 2023/ADMECoreClusterAnnotation_111723.csv")

#write.csv(ADMEExtended_Clusters, "/active/paquette_a/slapehn/Placenta_CellLine_Comparison/Results/Clustering Nov 2023/ADMEExtendedClusterAnnotation_111723.csv")
```
...
#write.csv(clusters8_annotation_test, "/active/paquette_a/slapehn/Placenta_CellLine_Comparison/Results/Clustering Nov 2023/GeneClusterMembership_111723.csv")
```
