---
title: "Differential Expression Analysis- Villous Digest STB Analysis"
...
```{r load data}
load(file="/active/paquette_a/slapehn/Placenta_CellLine_Comparison/Data/Merged Filtered Data/FilteredCounts_FACS_STB_111723.RData")
Sample_Metadata <- read.csv("/active/paquette_a/slapehn/Placenta_CellLine_Comparison/SampleID_Key_FACS_STBs_Nov2023.csv")
```
...
CellLine<-factor(Sample_Metadata$Cell_Line_Syn,levels=c("STB", "Primary","BeWo", "BeWo_Syn", "JEG3", "HTR8SVneo", "JAR"))
...
#Step 2: Pull all results (order "STB", "Primary","BeWo", "BeWo_Syn", "JEG3", "HTR8SVneo", "JAR")
...
#write.csv(Sig_Combined, "/active/paquette_a/slapehn/Placenta_CellLine_Comparison/SupplementalMaterials/FACS_STB_DEGs_SuppTable_120123.csv")
...
#Export to be used as supplemental table
write.csv(AllResults_Combined, "/active/paquette_a/slapehn/Placenta_CellLine_Comparison/SupplementalMaterials/FACS_STB_AllResults_SuppTable_120123.csv")
