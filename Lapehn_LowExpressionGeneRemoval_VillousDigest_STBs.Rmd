---
title: "Low Expression Gene Removal (avg logcpm<0)- Villous Digest STBs"
...
## Sept 2024 Filtering for FACS STB Analysis
Performing  filtering to remove non-protein coding genes and low expressing genes. Sept 2024- adding TSCs
...
```{r load data}
#Full Merged Data
load(file="/active/paquette_a/slapehn/Placenta_CellLine_Comparison/Data/Merged Unfiltered Data/FullMerge_Unfiltered_FACS_STB_091324.Rdata")
```
...
Filtered_Counts_DF <- Filtered_Counts_DF[,-150]
...
Filtered_logcpm_DF <- Filtered_logcpm_DF[,-150]
...
#save(FilteredCounts_DF_Annotated, file="/active/paquette_a/slapehn/Placenta_CellLine_Comparison/Data/Merged Filtered Data/FilteredwithAnnotation_FACS_STB_091324.RData")
#save(Filtered_Counts_DF, file="/active/paquette_a/slapehn/Placenta_CellLine_Comparison/Data/Merged Filtered Data/FilteredCounts_FACS_STB_091324.RData")
#save(Filtered_logcpm_DF_Annotated, file="/active/paquette_a/slapehn/Placenta_CellLine_Comparison/Data/Merged Filtered Data/Filtered_logcpm_withAnnotation_FACS_STB_091324.RData")
#save(Filtered_logcpm_DF, file="/active/paquette_a/slapehn/Placenta_CellLine_Comparison/Data/Merged Filtered Data/Filtered_logcpm_FACS_STB_091324.RData")
#save(Removed_Genes_DF_Annotated, file="/active/paquette_a/slapehn/Placenta_CellLine_Comparison/Data/Merged Filtered Data/RemovedGenes_counts_FACS_STB_091324.RData")
#save(Removed_Genes_logcpm_DF, file="/active/paquette_a/slapehn/Placenta_CellLine_Comparison/Data/Merged Filtered Data/RemovedGenes_logcpm_FACS_STB_091324.RData")
```
