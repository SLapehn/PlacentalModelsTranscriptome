---
title: "Differential Expression Analysis- FACS CTB Analysis"
...
## Differential Expression Analysis- FACS CTB Analysis
...
```{r load data}
load(file="/active/paquette_a/slapehn/Placenta_CellLine_Comparison/Data/Merged Filtered Data/FilteredCounts_FACS_CTB_111723.RData")
Sample_Metadata <- read.csv("/active/paquette_a/slapehn/Placenta_CellLine_Comparison/SampleID_Key_FACS_CTBs_Nov2023.csv")
```
...
CellLine<-factor(Sample_Metadata$Cell_Line_Syn,levels=c("CTB", "Primary","BeWo", "BeWo_Syn", "JEG3", "HTR8SVneo", "JAR"))
...
#Step 2: Pull all results (order "CTB", "Primary","BeWo", "BeWo_Syn", "JEG3", "HTR8SVneo", "JAR")
...
plot_DF %>%
  ...
  ggtitle("Differentially Expressed Genes (FDR<0.01) compared to CTBs") + 
...
color[which(Metadata_PCs_post$Cell_Line_Syn=="CTB")] = "blue"
...
#write.csv(Sig_Combined, "/active/paquette_a/slapehn/Placenta_CellLine_Comparison/SupplementalMaterials/FACS_CTB_DEGs_SuppTable_120123.csv")
...
#Export to be used as supplemental table
#write.csv(AllResults_Combined, "/active/paquette_a/slapehn/Placenta_CellLine_Comparison/SupplementalMaterials/FACS_CTB_AllResults_SuppTable_120123.csv")
