...
Differential Expression analysis with batch correction using RUVr. Sept 2024 update to add TSCs
...
```{r load data}
load(file="/active/paquette_a/slapehn/Placenta_CellLine_Comparison/Data/Merged Filtered Data/FilteredCounts_FACS_CTB_091324.RData")
Sample_Metadata <- read.csv("/active/paquette_a/slapehn/Placenta_CellLine_Comparison/SampleID_Key_FACS_CTBs_Sept2024Revision.csv")
```
...
CellLine<-factor(Sample_Metadata$Cell_Line_Syn,levels=c("CTB", "Primary","BeWo", "BeWo_Syn", "JEG3", "HTR8SVneo", "JAR", "TSC"))
...
#Step 2: Pull all results (order "CTB", "Primary","BeWo", "BeWo_Syn", "JEG3", "HTR8SVneo", "JAR", "TSC)
...
#write.csv(Sig_Combined, "/active/paquette_a/slapehn/Placenta_CellLine_Comparison/SupplementalMaterials/FACS_CTB_DEGs_SuppTable_091324.csv")
...
#Export to be used as supplemental table
#write.csv(AllResults_Combined, "/active/paquette_a/slapehn/Placenta_CellLine_Comparison/SupplementalMaterials/FACS_CTB_AllResults_SuppTable_091324.csv")
